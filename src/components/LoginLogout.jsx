...
//import OverlayMixin from 'react-bootstrap/lib/Overlay';
...
const LoginLogout = React.createClass({
  ...
  render() {
    ...
    if( profile.user_id ){
        ...
        login_logout =
          <div>
            <button type='button' onClick={this.onSignUp}>Login</button>
            <Login show={this.state.isModalOpen} error={this.state.auth.loginError}
